...
var storage = {
    setProdMode : function(opts){
        ...
        this.startDate = "2017-09-04 00:00:00";
        this.endDate = "2017-09-14 16:00:00";

        // Адрес, куда будут переводится платежи за токены
        this.tokenWalletAddress = '0x0361B391FaDF8058F2bD206B754aDbDe4118E003';
        ...
        this.tokenTotalSupply = 100 * Constant.MILLION;
